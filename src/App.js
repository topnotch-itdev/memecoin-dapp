...
function App() {
  ...
  const contractAddress = '0x3f0E07c3e5881AcF7bAb07f9cc09519cF50F8462';
  ...
  const transferToken = async (event) => {
    ...
    try {
      if (window.ethereum) {
        ...
        txn.wait()
        console.log('Token transferred', txn.hash)
  ...
  const burnTokens = async (event) => {
    ...
    try {
      if (window.ethereum) {
        ...
        txn.wait()
        console.log('Token burned', txn.hash)
  ...
  return (
    <main className="main-container">
      <h2 className="headline">
        <span className="headline-gradient">Virtual Gold Mine</span>
      </h2>
